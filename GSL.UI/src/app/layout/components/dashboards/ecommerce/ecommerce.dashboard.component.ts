...
export class EcommerceDashboardComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.registerService.getCount().subscribe(data=>{
            this.RegisterCount = data;
            
        })

        this.agreementService.getCount().subscribe(data=>{
            this.AgreementCount = data;
        })
        this.applyService.getCount().subscribe(data=>{
            this.ApplyCount = data;
        })
        this.universityService.getCount().subscribe(data=>{
            this.UniversityCount =data;
        })
