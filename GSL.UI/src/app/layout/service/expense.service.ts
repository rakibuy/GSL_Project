...
getAll(): Observable<Payment[]> {
  return this.httpClient.get<Payment[]>(environment.baseUrl + '/Expense/GetAllExpense')
  .pipe(
...
create(session:any): Observable<Payment> {
  return this.httpClient.post<Payment>(environment.baseUrl + '/Expense/AddExpense', JSON.stringify(session), this.httpOptions)
  .pipe(
    catchError(this.errorHandler)
  )
}
...
find(id:any): Observable<Payment> {
  return this.httpClient.get<Payment>(environment.baseUrl + '/Expense/GetAllData?id=' + id)
  .pipe(
    catchError(this.errorHandler)
  )
}
getSingleInvoiceBYId(id:any){
  return this.httpClient.get<any>(environment.baseUrl + '/Expense/InvoicePdf?PaymenId=' + id)
  .pipe(
    catchError(this.errorHandler)
  )
}
...
singleAmountDetials(id:any): Observable<Payment> {
  return this.httpClient.get<Payment>(environment.baseUrl + '/Expense/InvoicePdf?PaymenId=' + id)
  .pipe(
    catchError(this.errorHandler)
  )
}
...
update(id:any, post:any): Observable<Payment> {
  return this.httpClient.put<Payment>(environment.baseUrl + '/Expense/UpdateExpance', JSON.stringify(post), this.httpOptions)
  .pipe(
    catchError(this.errorHandler)
  )
}
